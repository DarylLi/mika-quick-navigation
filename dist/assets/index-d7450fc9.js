 ...
 */var Yo=Symbol.for("react.element"),Gp=Symbol.for("react.portal"),Hp=Symbol.for("react.fragment"),Up=Symbol.for("react.strict_mode"),Vp=Symbol.for("react.profiler"),Jp=Symbol.for("react.provider"),Qp=Symbol.for("react.context"),qp=Symbol.for("react.forward_ref"),$p=Symbol.for("react.suspense"),Kp=Symbol.for("react.memo"),Xp=Symbol.for("react.lazy"),zc=Symbol.iterator;function Yp(e){return e===null||typeof e!="object"?null:(e=zc&&e[zc]||e["@@iterator"],typeof e=="function"?e:null)}var Ru={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},Wu=Object.assign,Gu={};function Zn(e,t,n){this.props=e,this.context=t,this.refs=Gu,this.updater=n||Ru}Zn.prototype.isReactComponent={};Zn.prototype.setState=function(e,t){if(typeof e!="object"&&typeof e!="function"&&e!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,e,t,"setState")};Zn.prototype.forceUpdate=function(e){this.updater.enqueueForceUpdate(this,e,"forceUpdate")};function Hu(){}Hu.prototype=Zn.prototype;function bs(e,t,n){this.props=e,this.context=t,this.refs=Gu,this.updater=n||Ru}var Ts=bs.prototype=new Hu;Ts.constructor=bs;Wu(Ts,Zn.prototype);Ts.isPureReactComponent=!0;var Mc=Array.isArray,Uu=Object.prototype.hasOwnProperty,As={current:null},Vu={key:!0,ref:!0,__self:!0,__source:!0};function Ju(e,t,n){var o,r={},a=null,i=null;if(t!=null)for(o in t.ref!==void 0&&(i=t.ref),t.key!==void 0&&(a=""+t.key),t)Uu.call(t,o)&&!Vu.hasOwnProperty(o)&&(r[o]=t[o]);var s=arguments.length-2;if(s===1)r.children=n;else if(1<s){for(var c=Array(s),l=0;l<s;l++)c[l]=arguments[l+2];r.children=c}if(e&&e.defaultProps)for(o in s=e.defaultProps,s)r[o]===void 0&&(r[o]=s[o]);return{$$typeof:Yo,type:e,key:a,ref:i,props:r,_owner:As.current}}function Zp(e,t){return{$$typeof:Yo,type:e.type,key:t,ref:e.ref,props:e.props,_owner:e._owner}}function Is(e){return typeof e=="object"&&e!==null&&e.$$typeof===Yo}function eg(e){var t={"=":"=0",":":"=2"};return"$"+e.replace(/[=:]/g,function(n){return t[n]})}var Fc=/\/+/g;function Ba(e,t){return typeof e=="object"&&e!==null&&e.key!=null?eg(""+e.key):t.toString(36)}function xr(e,t,n,o,r){var a=typeof e;(a==="undefined"||a==="boolean")&&(e=null);var i=!1;if(e===null)i=!0;else switch(a){case"string":case"number":i=!0;break;case"object":switch(e.$$typeof){case Yo:case Gp:i=!0}}if(i)return i=e,r=r(i),e=o===""?"."+Ba(i,0):o,Mc(r)?(n="",e!=null&&(n=e.replace(Fc,"$&/")+"/"),xr(r,t,n,"",function(l){return l})):r!=null&&(Is(r)&&(r=Zp(r,n+(!r.key||i&&i.key===r.key?"":(""+r.key).replace(Fc,"$&/")+"/")+e)),t.push(r)),1;if(i=0,o=o===""?".":o+":",Mc(e))for(var s=0;s<e.length;s++){a=e[s];var c=o+Ba(a,s);i+=xr(a,t,n,c,r)}else if(c=Yp(e),typeof c=="function")for(e=c.call(e),s=0;!(a=e.next()).done;)a=a.value,c=o+Ba(a,s++),i+=xr(a,t,n,c,r);else if(a==="object")throw t=String(e),Error("Objects are not valid as a React child (found: "+(t==="[object Object]"?"object with keys {"+Object.keys(e).join(", ")+"}":t)+"). If you meant to render a collection of children, use an array instead.");return i}function ir(e,t,n){if(e==null)return e;var o=[],r=0;return xr(e,o,"","",function(a){return t.call(n,a,r++)}),o}function tg(e){if(e._status===-1){var t=e._result;t=t(),t.then(function(n){(e._status===0||e._status===-1)&&(e._status=1,e._result=n)},function(n){(e._status===0||e._status===-1)&&(e._status=2,e._result=n)}),e._status===-1&&(e._status=0,e._result=t)}if(e._status===1)return e._result.default;throw e._result}var De={current:null},jr={transition:null},ng={ReactCurrentDispatcher:De,ReactCurrentBatchConfig:jr,ReactCurrentOwner:As};function Qu(){throw Error("act(...) is not supported in production builds of React.")}J.Children={map:ir,forEach:function(e,t,n){ir(e,function(){t.apply(this,arguments)},n)},count:function(e){var t=0;return ir(e,function(){t++}),t},toArray:function(e){return ir(e,function(t){return t})||[]},only:function(e){if(!Is(e))throw Error("React.Children.only expected to receive a single React element child.");return e}};J.Component=Zn;J.Fragment=Hp;J.Profiler=Vp;J.PureComponent=bs;J.StrictMode=Up;J.Suspense=$p;J.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=ng;J.act=Qu;J.cloneElement=function(e,t,n){if(e==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+e+".");var o=Wu({},e.props),r=e.key,a=e.ref,i=e._owner;if(t!=null){if(t.ref!==void 0&&(a=t.ref,i=As.current),t.key!==void 0&&(r=""+t.key),e.type&&e.type.defaultProps)var s=e.type.defaultProps;for(c in t)Uu.call(t,c)&&!Vu.hasOwnProperty(c)&&(o[c]=t[c]===void 0&&s!==void 0?s[c]:t[c])}var c=arguments.length-2;if(c===1)o.children=n;else if(1<c){s=Array(c);for(var l=0;l<c;l++)s[l]=arguments[l+2];o.children=s}return{$$typeof:Yo,type:e.type,key:r,ref:a,props:o,_owner:i}};J.createContext=function(e){return e={$$typeof:Qp,_currentValue:e,_currentValue2:e,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},e.Provider={$$typeof:Jp,_context:e},e.Consumer=e};J.createElement=Ju;J.createFactory=function(e){var t=Ju.bind(null,e);return t.type=e,t};J.createRef=function(){return{current:null}};J.forwardRef=function(e){return{$$typeof:qp,render:e}};J.isValidElement=Is;J.lazy=function(e){return{$$typeof:Xp,_payload:{_status:-1,_result:e},_init:tg}};J.memo=function(e,t){return{$$typeof:Kp,type:e,compare:t===void 0?null:t}};J.startTransition=function(e){var t=jr.transition;jr.transition={};try{e()}finally{jr.transition=t}};J.unstable_act=Qu;J.useCallback=function(e,t){return De.current.useCallback(e,t)};J.useContext=function(e){return De.current.useContext(e)};J.useDebugValue=function(){};J.useDeferredValue=function(e){return De.current.useDeferredValue(e)};J.useEffect=function(e,t){return De.current.useEffect(e,t)};J.useId=function(){return De.current.useId()};J.useImperativeHandle=function(e,t,n){return De.current.useImperativeHandle(e,t,n)};J.useInsertionEffect=function(e,t){return De.current.useInsertionEffect(e,t)};J.useLayoutEffect=function(e,t){return De.current.useLayoutEffect(e,t)};J.useMemo=function(e,t){return De.current.useMemo(e,t)};J.useReducer=function(e,t,n){return De.current.useReducer(e,t,n)};J.useRef=function(e){return De.current.useRef(e)};J.useState=function(e){return De.current.useState(e)};J.useSyncExternalStore=function(e,t,n){return De.current.useSyncExternalStore(e,t,n)};J.useTransition=function(){return De.current.useTransition()};J.version="18.3.1";Ou.exports=J;var ke=Ou.exports;const qu=vs(ke);/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ug=ke,qe=lg;function x(e){for(var t="https://reactjs.org/docs/error-decoder.html?invariant="+e,n=1;n<arguments.length;n++)t+="&args[]="+encodeURIComponent(arguments[n]);return"Minified React error #"+e+"; visit "+t+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var Zu=new Set,No={};function yn(e,t){Jn(e,t),Jn(e+"Capture",t)}function Jn(e,t){for(No[e]=t,e=0;e<t.length;e++)Zu.add(t[e])}var St=!(typeof window>"u"||typeof window.document>"u"||typeof window.document.createElement>"u"),yi=Object.prototype.hasOwnProperty,dg=/^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/,Oc={},Rc={};function pg(e){return yi.call(Rc,e)?!0:yi.call(Oc,e)?!1:dg.test(e)?Rc[e]=!0:(Oc[e]=!0,!1)}function gg(e,t,n,o){if(n!==null&&n.type===0)return!1;switch(typeof t){case"function":case"symbol":return!0;case"boolean":return o?!1:n!==null?!n.acceptsBooleans:(e=e.toLowerCase().slice(0,5),e!=="data-"&&e!=="aria-");default:return!1}}function mg(e,t,n,o){if(t===null||typeof t>"u"||gg(e,t,n,o))return!0;if(o)return!1;if(n!==null)switch(n.type){case 3:return!t;case 4:return t===!1;case 5:return isNaN(t);case 6:return isNaN(t)||1>t}return!1}function Be(e,t,n,o,r,a,i){this.acceptsBooleans=t===2||t===3||t===4,this.attributeName=o,this.attributeNamespace=r,this.mustUseProperty=n,this.propertyName=e,this.type=t,this.sanitizeURL=a,this.removeEmptyString=i}var Ae={};"children dangerouslySetInnerHTML defaultValue defaultChecked innerHTML suppressContentEditableWarning suppressHydrationWarning style".split(" ").forEach(function(e){Ae[e]=new Be(e,0,!1,e,null,!1,!1)});[["acceptCharset","accept-charset"],["className","class"],["htmlFor","for"],["httpEquiv","http-equiv"]].forEach(function(e){var t=e[0];Ae[t]=new Be(t,1,!1,e[1],null,!1,!1)});["contentEditable","draggable","spellCheck","value"].forEach(function(e){Ae[e]=new Be(e,2,!1,e.toLowerCase(),null,!1,!1)});["autoReverse","externalResourcesRequired","focusable","preserveAlpha"].forEach(function(e){Ae[e]=new Be(e,2,!1,e,null,!1,!1)});"allowFullScreen async autoFocus autoPlay controls default defer disabled disablePictureInPicture disableRemotePlayback formNoValidate hidden loop noModule noValidate open playsInline readOnly required reversed scoped seamless itemScope".split(" ").forEach(function(e){Ae[e]=new Be(e,3,!1,e.toLowerCase(),null,!1,!1)});["checked","multiple","muted","selected"].forEach(function(e){Ae[e]=new Be(e,3,!0,e,null,!1,!1)});["capture","download"].forEach(function(e){Ae[e]=new Be(e,4,!1,e,null,!1,!1)});["cols","rows","size","span"].forEach(function(e){Ae[e]=new Be(e,6,!1,e,null,!1,!1)});["rowSpan","start"].forEach(function(e){Ae[e]=new Be(e,5,!1,e.toLowerCase(),null,!1,!1)});var xs=/[\-:]([a-z])/g;function js(e){return e[1].toUpperCase()}"accent-height alignment-baseline arabic-form baseline-shift cap-height clip-path clip-rule color-interpolation color-interpolation-filters color-profile color-rendering dominant-baseline enable-background fill-opacity fill-rule flood-color flood-opacity font-family font-size font-size-adjust font-stretch font-style font-variant font-weight glyph-name glyph-orientation-horizontal glyph-orientation-vertical horiz-adv-x horiz-origin-x image-rendering letter-spacing lighting-color marker-end marker-mid marker-start overline-position overline-thickness paint-order panose-1 pointer-events rendering-intent shape-rendering stop-color stop-opacity strikethrough-position strikethrough-thickness stroke-dasharray stroke-dashoffset stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width text-anchor text-decoration text-rendering underline-position underline-thickness unicode-bidi unicode-range units-per-em v-alphabetic v-hanging v-ideographic v-mathematical vector-effect vert-adv-y vert-origin-x vert-origin-y word-spacing writing-mode xmlns:xlink x-height".split(" ").forEach(function(e){var t=e.replace(xs,js);Ae[t]=new Be(t,1,!1,e,null,!1,!1)});"xlink:actuate xlink:arcrole xlink:role xlink:show xlink:title xlink:type".split(" ").forEach(function(e){var t=e.replace(xs,js);Ae[t]=new Be(t,1,!1,e,"http://www.w3.org/1999/xlink",!1,!1)});["xml:base","xml:lang","xml:space"].forEach(function(e){var t=e.replace(xs,js);Ae[t]=new Be(t,1,!1,e,"http://www.w3.org/XML/1998/namespace",!1,!1)});["tabIndex","crossOrigin"].forEach(function(e){Ae[e]=new Be(e,1,!1,e.toLowerCase(),null,!1,!1)});Ae.xlinkHref=new Be("xlinkHref",1,!1,"xlink:href","http://www.w3.org/1999/xlink",!0,!1);["src","href","action","formAction"].forEach(function(e){Ae[e]=new Be(e,1,!1,e.toLowerCase(),null,!0,!0)});function Es(e,t,n,o){var r=Ae.hasOwnProperty(t)?Ae[t]:null;(r!==null?r.type!==0:o||!(2<t.length)||t[0]!=="o"&&t[0]!=="O"||t[1]!=="n"&&t[1]!=="N")&&(mg(t,n,r,o)&&(n=null),o||r===null?pg(t)&&(n===null?e.removeAttribute(t):e.setAttribute(t,""+n)):r.mustUseProperty?e[r.propertyName]=n===null?r.type===3?!1:"":n:(t=r.attributeName,o=r.attributeNamespace,n===null?e.removeAttribute(t):(r=r.type,n=r===3||r===4&&n===!0?"":""+n,o?e.setAttributeNS(o,t,n):e.setAttribute(t,n))))}var Bt=ug.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,sr=Symbol.for("react.element"),xn=Symbol.for("react.portal"),jn=Symbol.for("react.fragment"),Ss=Symbol.for("react.strict_mode"),ki=Symbol.for("react.profiler"),ed=Symbol.for("react.provider"),td=Symbol.for("react.context"),Ps=Symbol.for("react.forward_ref"),wi=Symbol.for("react.suspense"),vi=Symbol.for("react.suspense_list"),Cs=Symbol.for("react.memo"),Mt=Symbol.for("react.lazy"),nd=Symbol.for("react.offscreen"),Wc=Symbol.iterator;function io(e){return e===null||typeof e!="object"?null:(e=Wc&&e[Wc]||e["@@iterator"],typeof e=="function"?e:null)}var ue=Object.assign,Na;function yo(e){if(Na===void 0)try{throw Error()}catch(n){var t=n.stack.trim().match(/\n( *(at )?)/);Na=t&&t[1]||""}return`
...
`}];function ky(){var M,$;const[e,t]=ke.useState("开发工具"),[n,o]=ke.useState("开发IDE"),[r,a]=ke.useState(!0),[i,s]=ke.useState(!1),[c,l]=ke.useState(null);function u(){s(!1),l(null),document.body.style.overflow=""}const[d,g]=ke.useState(""),[p,k]=ke.useState([]),[v,D]=ke.useState(!1),m=[{id:255,parent_category:23,parent_category_name:"开发工具",sub_category:24,sub_category_name:"开发IDE",name:"IntelliJ IDEA",description:"一款由 JetBrains 开发的 智能 Java 集成开发环境（IDE），专为大型项目和企业级开发设计，Java 开发者的首选工具。",url:"https://www.jetbrains.com/idea/",icon:"https://kjdaohang.com/media/tool_icons/IntelliJ_IDEA.png",logo:"https://kjdaohang.com/media/tool_icons/IntelliJ_IDEA.png",tags:["Java开发首选"],order:0,is_active:!0,views:308,likes_count:0,created_at:"2025-05-22T17:59:29.576330+08:00",updated_at:"2025-05-29T20:22:36.487890+08:00"},{id:254,parent_category:23,parent_category_name:"开发工具",sub_category:24,sub_category_name:"开发IDE",name:"VS Code",description:"一款由微软开发的 开源、轻量级、跨平台 代码编辑器，支持几乎所有编程语言，成为全球开发者最喜爱的工具之一",url:"https://code.visualstudio.com/",icon:"https://kjdaohang.com/media/tool_icons/vscode.jpg",logo:"https://kjdaohang.com/media/tool_icons/vscode.jpg",tags:["微软","开源","万能IDE"],order:0,is_active:!0,views:252,likes_count:1,created_at:"2025-05-22T17:58:07.321278+08:00",updated_at:"2025-05-29T18:29:59.179174+08:00"},{id:409,parent_category:24,parent_category_name:"开发工具",sub_category:null,sub_category_name:"构建工具",name:"Webpack",description:"现代JavaScript应用的静态模块打包器，支持代码拆分和优化。",url:"https://webpack.js.org/",icon:"https://webpack.js.org/favicon.ico",logo:"https://webpack.js.org/icon-pwa-512x512.f352c1530754cb89e192.png",tags:["JavaScript","打包工具","构建"],order:1,is_active:!0,views:2200,likes_count:0,created_at:"2025-07-10T11:00:00+08:00",updated_at:"2025-07-10T11:00:00+08:00"},{id:322,parent_category:23,parent_category_name:"开发工具",sub_category:25,sub_category_name:"代码协作",name:"Codepen",description:"一个在线前端代码编辑和测试平台，用户可以在此编写、测试和分享HTML、CSS和JavaScript代码。",url:"https://codepen.io/pen/",icon:"https://kjdaohang.com/media/tool_icons/OIP-C_3.jpg",logo:"https://kjdaohang.com/media/tool_icons/OIP-C_3.jpg",tags:["Web前端","在线代码编辑器"],order:0,is_active:!0,views:37,likes_count:0,created_at:"2025-06-10T09:18:12.112395+08:00",updated_at:"2025-06-11T12:22:54.088820+08:00"},{id:21,parent_category:15,parent_category_name:"测试工具",sub_category:22,sub_category_name:"抓包工具",name:"Charles",description:"一款功能强大的 HTTP 代理工具，主要用于网络抓包、调试和分析 HTTP/HTTPS 等网络协议",url:"https://www.charlesproxy.com",icon:"https://kjdaohang.com/media/tool_icons/charles.png",logo:"https://kjdaohang.com/media/tool_icons/charles.png",tags:["抓包","HTTP 代理"],order:0,is_active:!0,views:297,likes_count:1,created_at:"2025-05-21T18:34:05.569666+08:00",updated_at:"2025-05-30T10:37:48.371977+08:00"},{id:434,parent_category:17,parent_category_name:"开发工具",sub_category:null,sub_category_name:"API工具",name:"Postman",description:"API开发和测试平台，支持API请求创建、调试和自动化测试。",url:"https://www.postman.com/",icon:"https://www.postman.com/favicon.ico",logo:"https://voyager.postman.com/logo/postman-logo-icon-orange.svg",tags:["API测试","API开发","自动化测试"],order:1,is_active:!0,views:2500,likes_count:0,created_at:"2025-07-10T16:00:00+08:00",updated_at:"2025-07-10T16:00:00+08:00"},{id:411,parent_category:40,parent_category_name:"运维工具",sub_category:null,sub_category_name:"CICD",name:"Jenkins",description:"开源的自动化服务器，支持持续集成和持续部署。",url:"https://www.jenkins.io/",icon:"https://www.jenkins.io/favicon.ico",logo:"https://www.jenkins.io/images/logos/jenkins/Jenkins.svg",tags:["自动化","CICD","开源"],order:1,is_active:!0,views:2100,likes_count:0,created_at:"2025-07-10T11:00:00+08:00",updated_at:"2025-07-10T11:00:00+08:00"},{id:447,parent_category:40,parent_category_name:"运维工具",sub_category:null,sub_category_name:"监控告警",name:"Sentry",description:"开源的错误监控和跟踪平台，帮助开发者实时发现、诊断和修复应用程序错误。",url:"https://sentry.io/",icon:"https://sentry.io/favicon.ico",logo:"https://sentry-brand.storage.googleapis.com/sentry-logo-black.png",tags:["错误监控","异常跟踪","性能监控"],order:3,is_active:!0,views:2e3,likes_count:0,created_at:"2025-07-11T11:00:00+08:00",updated_at:"2025-07-11T11:00:00+08:00"},{id:413,parent_category:34,parent_category_name:"设计工具",sub_category:null,sub_category_name:"原型设计",name:"Axure RP",description:"专业的原型设计工具，用于创建网站和应用程序的交互式原型。",url:"https://www.axure.com/",icon:"https://www.axure.com/favicon.ico",logo:"https://www.axure.com/wp-content/uploads/2019/07/axure-logo.svg",tags:["原型设计","交互设计","专业工具"],order:1,is_active:!0,views:1700,likes_count:0,created_at:"2025-07-10T12:00:00+08:00",updated_at:"2025-07-10T12:00:00+08:00"},{id:419,parent_category:40,parent_category_name:"运维工具",sub_category:null,sub_category_name:"容器管理",name:"Docker",description:"开源的容器化平台，使开发者能够打包应用及其依赖项到一个可移植的容器中。",url:"https://www.docker.com/",icon:"https://www.docker.com/favicon.ico",logo:"https://www.docker.com/wp-content/uploads/2022/03/Moby-logo.png",tags:["容器化","虚拟化","开发运维"],order:1,is_active:!0,views:2500,likes_count:0,created_at:"2025-07-10T13:00:00+08:00",updated_at:"2025-07-10T13:00:00+08:00"}],h={开发工具:{icon:cy,color:"from-green-500 to-teal-500",subCategories:["开发IDE","低代码/无代码","静态代码分析","构建工具","代码评审","代码协作"]},设计工具:{icon:gy,color:"from-pink-500 to-rose-500",subCategories:["流程图设计","3D设计","原型设计","UI设计"]},测试工具:{icon:hy,color:"from-red-500 to-orange-500",subCategories:["AI测试","抓包工具","API测试","测试管理","构造数据","安全测试","性能测试","自动化测试","单元测试"]},运维工具:{icon:my,color:"from-indigo-500 to-purple-500",subCategories:["容器管理","CICD","自动化运维","监控告警"]},办公软件:{icon:ay,color:"from-blue-500 to-cyan-500",subCategories:["知识库","问卷表单","在线文档","工具箱","PDF工具","在线翻译","表格处理"]},AI工具:{icon:ly,color:"from-purple-500 to-blue-500",subCategories:["AI写作","AI绘画","AI编程","AI音频","AI视频","AI搜索","AI设计","AI智能体","AI数字人","AI办公神器","AI智能助手"]},面试工具:{icon:dy,color:"from-yellow-500 to-orange-500",subCategories:["面试刷题","简历制作","求职求聘"]},实用小工具:{icon:Mu,color:"from-gray-500 to-slate-500",subCategories:["图片压缩","图片编辑","翻译工具","格式转换","浏览器插件","PPT工具","Windows工具","表情包","在线工具","二维码制作"]},自媒体工具:{icon:fy,color:"from-red-500 to-pink-500",subCategories:["素材库","直播录制","视频下载","聚合网站","视频剪辑"]},资源网站:{icon:Lu,color:"from-emerald-500 to-green-500",subCategories:["大模型云平台","副业项目","网盘资源","学习资源","便民查询","休闲娱乐"]}},[f,T]=ke.useState({}),[E,b]=ke.useState(!0),[S,B]=ke.useState([]);ke.useEffect(()=>{try{const C={},O=[];fo.forEach(R=>{if(!R.is_active)return;const G=R.sub_category_name||R.parent_category_name,I={name:R.name,desc:R.description||"暂无描述",desc_md:R.desc_md||"暂无描述",tags:R.tags?R.tags.split(",").filter(F=>F.trim()):[],color:z(),link:R.url||"#",icon:R.icon||R.logo,parent_category:R.parent_category_name,sub_category:R.sub_category_name};C[G]||(C[G]=[]),C[G].push(I),O.push(I)}),Object.keys(C).forEach(R=>{C[R].sort((G,I)=>{const F=fo.findIndex(y=>y.name===G.name),_=fo.findIndex(y=>y.name===I.name),Q=F!==-1?fo[F].views:0;return(_!==-1?fo[_].views:0)-Q})}),T(C),B(O)}catch(C){console.error("处理工具数据时出错:",C)}finally{b(!1)}},[]);const W=()=>{const C=d;if(!C.trim()){k([]),D(!1),t("AI工具"),o("AI写作");return}D(!0),setTimeout(()=>{const O=C.toLowerCase().trim(),R=S.filter(G=>G.name.toLowerCase().includes(O)||G.desc.toLowerCase().includes(O)||G.tags.some(I=>I.toLowerCase().includes(O)));if(k(R),R.length>0){const G=R[0];G.parent_category&&(t(G.parent_category),G.sub_category&&G.sub_category!==null?o(G.sub_category):G.parent_category&&h[G.parent_category]&&o(h[G.parent_category].subCategories[0])),a(!0)}},300)},z=()=>{const C=["#ff6b6b","#4ecdc4","#45b7d1","#96ceb4","#feca57","#ff9ff3","#54a0ff","#5f27cd","#00d2d3","#ff9f43","#ee5253","#10ac84","#5f27cd","#0abde3","#54a0ff"];return C[Math.floor(Math.random()*C.length)]},N=n==="hotTools"?m:f[n]||[];return console.log(N),w.jsxs("div",{className:"flex h-screen bg-gray-50",children:[i&&c&&!1,i&&c&&w.jsx("div",{className:"fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50",style:{backdropFilter:"blur(2px)"},children:w.jsxs("div",{className:"modal-dom relative bg-white rounded-2xl shadow-2xl p-8 overflow-y-auto animate-fadeIn",style:{width:"75vw",height:"75vh",maxHeight:"95vh"},children:[w.jsx("button",{className:"absolute top-4 right-4 text-gray-400 hover:text-gray-700 text-2xl font-bold z-10",onClick:u,"aria-label":"关闭",children:w.jsx(yy,{size:32})}),w.jsxs("div",{className:"flex items-center mb-6 gap-4",children:[c.icon?w.jsx("img",{src:c.icon,alt:c.name,className:"w-16 h-16 rounded-lg shadow"}):w.jsx("div",{className:"w-16 h-16 rounded-lg flex items-center justify-center text-white font-bold text-2xl",style:{backgroundColor:c.color},children:c.name.charAt(0)}),w.jsxs("div",{children:[w.jsx("h2",{className:"text-2xl font-bold text-gray-800 mb-1",children:c.name}),w.jsx("div",{className:"flex flex-wrap gap-2",children:c.tags.map((C,O)=>w.jsx("span",{className:"text-xs bg-blue-50 text-blue-600 px-2 py-0.5 rounded",children:C.trim()},O))})]})]}),w.jsx("div",{className:"prose max-w-none mb-6",style:{minHeight:120,fontSize:18},children:w.jsx(Kf,{children:c.desc_md})}),w.jsxs("div",{className:"flex justify-end gap-4",children:[w.jsxs("a",{href:c.link,target:"_blank",rel:"noopener noreferrer",className:"bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg font-semibold shadow transition",children:["访问工具 ",w.jsx(uy,{className:"inline ml-1",size:18})]}),w.jsx("button",{className:"bg-gray-200 hover:bg-gray-300 text-gray-700 px-6 py-2 rounded-lg font-semibold transition",onClick:u,children:"关闭"})]})]})}),w.jsxs("div",{className:`${r?"w-48":"w-16"} mk-side-bar border-r border-gray-200 flex flex-col transition-all duration-300`,children:[w.jsx("div",{className:"p-4 border-b border-gray-100 flex items-center justify-between",style:{position:"absolute",padding:"0",transition:"all .3s",overflow:"hidden",left:r?"145px":"56px",borderBottom:"0px",top:"9px"},children:w.jsx("button",{onClick:()=>a(!r),className:`p-2 rounded-lg ${r?"":"need-open"}`,children:r?w.jsx(sy,{size:20,className:"text-gray-600"}):w.jsxs(w.Fragment,{children:[w.jsx(hi,{size:20,className:"text-gray-600"}),w.jsx(hi,{size:20,className:"text-gray-600"}),w.jsx(hi,{size:20,className:"text-gray-600"})]})})}),w.jsx("div",{className:"px-3 pb-2",style:{paddingLeft:"0px",paddingRight:"0px",marginTop:"5px"},children:w.jsxs("button",{className:"w-full flex items-center space-x-2 px-2 py-2 text-red-500 bg-red-50 rounded-lg",style:{justifyContent:r?"left":"center"},onClick:()=>o("hotTools"),children:[w.jsx("span",{className:"text-xl",children:"🔥"}),r&&w.jsx("span",{className:"text-sm font-bold",children:"热门推荐"})]})}),w.jsx("div",{className:"flex-1 overflow-y-auto px-3 space-y-1",children:Object.entries(h).map(([C,O])=>{const R=O.icon,G=e===C;return w.jsxs("div",{children:[w.jsxs("button",{onClick:()=>{t(C),o(O.subCategories[0])},className:`w-full flex items-center space-x-2 px-3 py-2 rounded-lg transition-all ${G?"bg-blue-500 text-white shadow-md":"text-gray-700 hover:bg-gray-100"}`,children:[w.jsx(R,{size:18}),r&&w.jsxs(w.Fragment,{children:[w.jsx("span",{className:"text-md font-bold flex-1 text-left",children:C}),w.jsx(iy,{size:14,className:`transform transition-transform ${G?"rotate-180":""}`})]})]}),G&&r&&w.jsx("div",{className:"ml-4 mt-1 space-y-1",children:O.subCategories.map(I=>w.jsx("button",{onClick:()=>o(I),className:`w-full text-left px-3 py-1.5 rounded text-sm transition ${n===I?"bg-blue-50 text-blue-600 font-medium":"text-gray-600 hover:bg-gray-50"}`,children:I},I))})]},C)})})]}),w.jsxs("div",{className:"flex-1 flex flex-col overflow-hidden",children:[w.jsxs("div",{className:"color-change-infinite",children:[w.jsxs("div",{className:"top-content bg-gradient-to-r from-purple-600 via-purple-500 to-blue-500 text-white shadow-lg",children:[w.jsxs("div",{className:"px-6 py-3 flex items-center justify-between",children:[w.jsx("div",{className:"flex items-center space-x-6",children:w.jsx("div",{className:"flex items-center space-x-2",children:w.jsx("span",{className:"font-bold text-lg",children:"Mika导航之家"})})}),w.jsxs("div",{className:"flex items-center space-x-6 text-sm",style:{display:"none"},children:[w.jsxs("a",{href:"#",className:"flex items-center space-x-1 hover:text-purple-200 transition",children:[w.jsx(py,{size:16}),w.jsx("span",{children:"首页"})]}),w.jsxs("a",{href:"#",className:"flex items-center space-x-1 hover:text-purple-200 transition",children:[w.jsx(oy,{size:16}),w.jsx("span",{children:"最新上架"})]}),w.jsxs("a",{href:"#",className:"flex items-center space-x-1 hover:text-purple-200 transition",children:[w.jsx(_y,{size:16}),w.jsx("span",{children:"喜爱收藏"})]}),w.jsx("a",{href:"#",className:"flex items-center space-x-1 hover:text-purple-200 transition",children:w.jsx("span",{children:"我的导航"})}),w.jsxs("a",{href:"#",className:"flex items-center space-x-1 hover:text-purple-200 transition",children:[w.jsx(ry,{size:16}),w.jsx("span",{children:"免费教程"})]}),w.jsx("button",{className:"hover:text-purple-200 transition",children:"收录申请"}),w.jsx("button",{className:"hover:text-purple-200 transition",children:"联系我"})]})]}),w.jsx("div",{className:"px-6 pb-3",children:w.jsx("div",{className:"bg-white/10 backdrop-blur-sm rounded-lg px-4 py-2 flex items-center justify-between",children:w.jsxs("div",{className:"flex items-center space-x-3",children:[w.jsx("span",{className:"bg-red-500 text-white text-xs px-2 py-0.5 rounded font-bold",children:"NEW"}),w.jsx("span",{className:"text-sm",children:"最新更新    | Mika导航工具页上线~     2025-10-09"})]})})})]}),w.jsx("div",{className:"top-content bg-gradient-to-b from-purple-500 to-purple-600 px-6 py-12",children:w.jsxs("div",{className:"max-w-4xl mx-auto",children:[w.jsx("h1",{className:"text-header text-white text-3xl font-bold text-center mb-8",children:"工具搜索"}),w.jsxs("div",{className:"flex items-center bg-white rounded-full shadow-2xl overflow-hidden",children:[w.jsx("select",{className:"px-6 py-4 bg-transparent border-none outline-none text-gray-700 font-medium",children:w.jsx("option",{children:"站内"})}),w.jsx("input",{type:"text",placeholder:"搜索全网优质工具...",className:"flex-1 px-4 py-4 outline-none text-gray-700",value:d,onChange:C=>g(C.target.value),onKeyPress:C=>{C.key==="Enter"&&W()}}),w.jsx("button",{className:"search-button bg-gradient-to-r from-blue-500 to-cyan-400 text-white px-8 py-4 hover:from-blue-600 hover:to-cyan-500 transition",onClick:W,children:w.jsx(zu,{size:20})})]}),w.jsx("div",{className:"mt-4 flex items-center justify-center space-x-6 text-white text-sm",children:w.jsx("button",{className:"bg-green-500 hover:bg-orange-600 px-4 py-1.5 rounded-lg font-medium transition",children:"Ctrl+D 收藏本站"})})]})})]}),w.jsx("div",{className:"flex-1 overflow-y-auto bg-gray-50 mt-5",children:w.jsxs("div",{className:"max-w-7xl mx-auto p-6",children:[n==="hotTools"?w.jsxs("div",{className:"text-md font-semibold pb-5 text-red-500  font-bold",children:[w.jsx("span",{className:"text-2xl",children:"🔥"}),w.jsx("span",{className:"text-2xl",children:"🔥"}),w.jsx("span",{className:"text-2xl",children:"🔥"}),w.jsx("span",{className:"font-semibold text-2xl pb-5 text-red-500  font-bold",children:"火热推荐"}),w.jsx("span",{className:"text-2xl",children:"🔥"}),w.jsx("span",{className:"text-2xl",children:"🔥"}),w.jsx("span",{className:"text-2xl",children:"🔥"})]}):w.jsxs("div",{className:"mb-6",children:[w.jsxs("div",{className:"flex items-center space-x-3 mb-4",children:[w.jsx("div",{className:`w-10 h-10 rounded-lg bg-gradient-to-br ${((M=h[e])==null?void 0:M.color)||"from-gray-400 to-gray-500"} flex items-center justify-center`,children:($=h[e])!=null&&$.icon?qu.createElement(h[e].icon,{size:24,className:"text-white"}):w.jsx(Lu,{size:24,className:"text-white"})}),w.jsx("h2",{className:"text-2xl font-bold text-gray-800",children:e})]}),w.jsxs("div",{className:"bg-blue-50 border border-blue-100 rounded-lg px-4 py-3 flex items-center space-x-3",children:[w.jsx("span",{className:"text-2xl",children:"📁"}),w.jsx("span",{className:"font-semibold text-purple-900",children:n})]})]}),v&&w.jsx("div",{className:"mb-6 bg-white rounded-lg p-4 shadow-sm",children:w.jsxs("div",{className:"flex items-center justify-between",children:[w.jsxs("h3",{className:"font-semibold text-gray-800",children:["搜索结果: ",p.length,' 个工具匹配 "',d,'"']}),v&&w.jsx("button",{className:"text-sm text-blue-500 hover:text-blue-700 transition",onClick:()=>{g(""),k([]),D(!1),t("AI工具"),o("AI写作")},children:"清除搜索"})]})}),E?w.jsx("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5",children:Array.from({length:8}).map((C,O)=>w.jsxs("div",{className:"bg-white rounded-xl border border-gray-200 p-5 animate-pulse",children:[w.jsxs("div",{className:"flex items-start space-x-3 mb-3",children:[w.jsx("div",{className:"w-12 h-12 rounded-lg bg-gray-200 flex-shrink-0"}),w.jsxs("div",{className:"flex-1",children:[w.jsx("div",{className:"h-4 bg-gray-200 rounded w-3/4 mb-2"}),w.jsxs("div",{className:"flex space-x-1",children:[w.jsx("div",{className:"h-4 bg-gray-200 rounded w-16"}),w.jsx("div",{className:"h-4 bg-gray-200 rounded w-20"})]})]})]}),w.jsx("div",{className:"h-12 bg-gray-200 rounded w-full mb-4"}),w.jsxs("div",{className:"flex justify-between items-center",children:[w.jsx("div",{className:"h-4 bg-gray-200 rounded w-24"}),w.jsx("div",{className:"h-4 bg-gray-200 rounded w-20"})]})]},O))}):v?p.length>0?w.jsx("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5",children:p.map((C,O)=>w.jsxs("div",{className:"bg-white rounded-xl border border-gray-200 hover:border-blue-300 hover:shadow-xl transition-all p-5 group",children:[w.jsxs("div",{className:"flex items-start space-x-3 mb-3",children:[w.jsx("div",{className:"w-12 h-12 rounded-lg flex items-center justify-center text-white font-bold text-lg flex-shrink-0 shadow-md overflow-hidden",style:{backgroundColor:C.color},children:C.icon?w.jsx("img",{src:C.icon,alt:C.name,className:"w-full h-full object-cover transition-transform group-hover:scale-110",onError:R=>{const I=R.target.parentElement;I&&(I.innerHTML=C.name.charAt(0))}}):C.name.charAt(0)}),w.jsxs("div",{className:"flex-1 min-w-0",children:[w.jsx("h3",{className:"font-bold text-gray-800 group-hover:text-blue-600 transition mb-1 truncate",children:C.name}),w.jsx("div",{className:"flex flex-wrap gap-1",children:C.tags.map((R,G)=>w.jsx("span",{className:"text-xs bg-blue-50 text-blue-600 px-2 py-0.5 rounded",children:R.trim()},G))})]})]}),w.jsx("p",{className:"text-sm text-gray-600 mb-4 line-clamp-2 leading-relaxed",children:C.desc}),w.jsxs("div",{className:"flex items-center justify-between text-sm",children:[w.jsxs("a",{href:C.link,target:"_blank",rel:"noopener noreferrer",className:"text-blue-600 hover:text-blue-700 font-medium flex items-center space-x-1 transition",onClick:R=>{C.link==="#"&&(R.preventDefault(),alert("该工具链接暂时不可用"))},children:[w.jsx("span",{children:"直达链接"}),w.jsx("span",{className:"transition-transform group-hover:translate-x-1",children:"🔗"})]}),w.jsxs("button",{className:"text-gray-500 hover:text-blue-600 transition flex items-center space-x-1",onClick:()=>{l(C),s(!0),document.body.style.overflow="hidden"},children:[w.jsx("span",{children:"查看详情"}),w.jsx("span",{className:"transition-transform group-hover:translate-x-1",children:"→"})]})]})]},C.name+O))}):w.jsxs("div",{className:"bg-white rounded-xl border-2 border-dashed border-gray-300 p-12 text-center",children:[w.jsx("div",{className:"w-24 h-24 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-4",children:w.jsx(zu,{size:40,className:"text-gray-400"})}),w.jsx("h3",{className:"text-xl font-semibold text-gray-700 mb-2",children:"未找到相关工具"}),w.jsxs("p",{className:"text-gray-500 mb-6",children:['没有找到与 "',d,'" 相关的工具，请尝试其他关键词']}),w.jsx("button",{className:"bg-blue-500 hover:bg-blue-600 text-white px-6 py-2 rounded-lg transition",onClick:()=>{g(""),k([]),D(!1),t("AI工具"),o("AI写作")},children:"返回全部工具"})]}):N&&N.length>0?w.jsx("div",{className:"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5",children:N.map((C,O)=>w.jsxs("div",{className:"bg-white rounded-xl border border-gray-200 hover:border-blue-300 hover:shadow-xl transition-all p-5 group",children:[w.jsxs("div",{className:"flex items-start space-x-3 mb-3",children:[w.jsx("div",{className:"w-12 h-12 rounded-lg flex items-center justify-center text-white font-bold text-lg flex-shrink-0 shadow-md overflow-hidden",style:{backgroundColor:C.color},children:C.icon?w.jsx("img",{src:C.icon,alt:C.name,className:"w-full h-full object-cover transition-transform group-hover:scale-110",onError:R=>{const I=R.target.parentElement;I&&(I.innerHTML=C.name.charAt(0))}}):C.name.charAt(0)}),w.jsxs("div",{className:"flex-1 min-w-0",children:[w.jsx("h3",{className:"font-bold text-gray-800 group-hover:text-blue-600 transition mb-1 truncate",children:C.name}),w.jsx("div",{className:"flex flex-wrap gap-1",children:C.tags.map((R,G)=>w.jsx("span",{className:"text-xs bg-blue-50 text-blue-600 px-2 py-0.5 rounded",children:R.trim()},G))})]})]}),w.jsx("p",{className:"text-sm text-gray-600 mb-4 line-clamp-2 leading-relaxed",children:C.desc}),w.jsxs("div",{className:"flex items-center justify-between text-sm",children:[w.jsxs("a",{href:C.link,target:"_blank",rel:"noopener noreferrer",className:"text-blue-600 hover:text-blue-700 font-medium flex items-center space-x-1 transition",onClick:R=>{C.link==="#"&&(R.preventDefault(),alert("该工具链接暂时不可用"))},children:[w.jsx("span",{children:"直达链接"}),w.jsx("span",{className:"transition-transform group-hover:translate-x-1",children:"🔗"})]}),w.jsxs("button",{className:"text-gray-500 hover:text-blue-600 transition flex items-center space-x-1",onClick:()=>{l(C),s(!0),document.body.style.overflow="hidden"},children:[w.jsx("span",{children:"查看详情"}),w.jsx("span",{className:"transition-transform group-hover:translate-x-1",children:"→"})]})]})]},C.name+O))}):w.jsxs("div",{className:"bg-white rounded-xl border-2 border-dashed border-gray-300 p-12 text-center",children:[w.jsx("div",{className:"w-24 h-24 bg-gray-100 rounded-full flex items-center justify-center mx-auto mb-4",children:w.jsx(Mu,{size:40,className:"text-gray-400"})}),w.jsxs("h3",{className:"text-xl font-semibold text-gray-700 mb-2",children:[n," - 内容即将上线"]}),w.jsx("p",{className:"text-gray-500",children:"该分类下的优质工具正在精心整理中，敬请期待..."})]})]})})]})]})}function wy(){return w.jsx("div",{className:"App",children:w.jsx(ky,{})})}fi.createRoot(document.getElementById("root")).render(w.jsx(qu.StrictMode,{children:w.jsx(wy,{})}));
